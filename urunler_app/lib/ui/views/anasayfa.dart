...
class _AnasayfaState extends State<Anasayfa> {
  Future<List<Urunler>> urunleriYukle() async {
    ...
    var u2 = Urunler(id: 2 ,ad :"Rayban Club Master" ,resim :"gozluk.png",fiyat :25000);
                    ...
                    child: Row(
                      children: [
                        ...
                        Column(crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(urun.ad),
                            const SizedBox(height: 10,),//Sabit boşluk eklendi
                            Text("${urun.fiyat}tl ",style : const TextStyle(fontSize: 20),),
                            const SizedBox(height: 20,),//Sabit boşluk eklendi
